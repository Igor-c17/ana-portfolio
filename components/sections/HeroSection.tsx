...
async function HeroSection() {
	...
	return (
		<section
			id="home"
			className="relative min-h-screen flex items-center justify-center px-6 pt-20 pb-0 overflow-hidden"
		>
									...
									<div className="flex items-center gap-2">
										<span>
											<Icon
												src="/email.png"
												alt="Disponibilidade"
												className="relative left-[px] top-[2px] w-5 h-5"
											/>
										</span>
									...
									<div className="flex items-center gap-2">
										<span>
											<Icon
												src="/checklist.png"
												alt="Disponibilidade"
												className="relative left-[3px] top-[2px] w-5 h-5"
											/>
										</span>
