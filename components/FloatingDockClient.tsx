...
export function FloatingDockClient({ navItems }: FloatingDockClientProps) {
	...
	// Foco bonito (e redondo) pra não aparecer aquele quadrado bugado
	const dockFocusable =
		"rounded-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/50 focus-visible:ring-offset-2 focus-visible:ring-offset-background";
					...
					{desktop.shouldShowMore && (
						<div className="relative">
							<button
								type="button"
								onClick={(e) => {
									setDesktopMoreMenuOpen(!desktopMoreMenuOpen);
									(e.currentTarget as HTMLButtonElement).blur();
								}}
								className={`group relative flex items-center justify-center w-12 h-12 md:w-12 md:h-12 ${dockFocusable}`}
							>
						...
						{mobile.shouldShowMore && (
							<div className="relative">
								<button
									...
									className={`group relative flex items-center justify-center w-12 h-12 ${dockFocusable}`}
								>
